		...
		<form method="post">
			<table class="input">
				...
				<tr>
					...
					<input type="number" min="1" max="5" name="tdFlag">
					</td>
					...
					<td>
					<input type="checkbox" id="tdAlaram" name="tdAlaram" value="Y">
		...
		<article id="list">
			...
			<table class="list">
				...
				<c:forEach items="${TODOLIST}" var="todo" varStatus="index">
					...
					<td><a href="${rootPath}/alaram?tdSeq=${todo.tdSeq}&tdAlaram=${todo.tdAlaram}">${todo.tdAlaram}</a></td>
					<td><a href="${rootPath}/update?tdSeq=${todo.tdSeq}">수정</a></td>
					<td><a href="${rootPath}/delete?tdSeq=${todo.tdSeq}">삭제</a></td>
					</tr>
