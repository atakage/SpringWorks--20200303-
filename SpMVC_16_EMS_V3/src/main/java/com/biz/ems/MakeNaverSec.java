...
public class MakeNaverSec {
	...
	public static void main(String[] args) {
		...
		if(saltPass == null || saltPass.isEmpty()) {
			...
			System.out.println("saltPassword is not found");
			return;
		...
		// 암호화 설정
				...
				secFileList.put("naver.email.properties", new String[] {"naver.username", "naver.password", "naver.client.id", "naver.client.secret"});
