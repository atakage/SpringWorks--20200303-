...
<form:form modelAttribute="emailVO">
	...
	<div class="in-box2">
		...
		<div class="content">${emailVO.from_email}</div>
	</div>
	...
	<div class="in-box2">
		...
		<div class="content">${emailVO.send_date}</div>
		<div class="title"><b>작성시각</b></div>
		<div class="content">${emailVO.send_time}</div>
	</div>
	...
	<div class="in-box2">
		...
		<div class="content">${emailVO.from_name}</div>
	</div>
	...
	<input id="hidden_seq" type="hidden" value="${emailVO.ems_seq}">
	
	<div class="button_set">
	<button id="update_button" class="button" type="button" style="color: green">수정</button>
	<button id="delete_button" class="button" type="button" style="color: red">삭제</button>
