package com.biz.ems.respository;
...
public interface EmailDao extends CrudRepository<EmailVO, Long>{
	...
	// select * from tbl_ems where 
	List<EmailVO> findAllByFromEmail(String from_email);
	List<EmailVO> findAllByFromEmailOrderByEmsSeq(String from_email);
	...
	List<EmailVO> findAllByFromEmailOrFromName(@Param("from_email") String from_email, @Param("from_name") String from_name);
