...
@ToString
@Builder
@Alias("todoDTO")			// mybatis-context.xml에서 typeAliasesPackage 속성을 사용할 경우 alias 이름이 자동으로 클래스 첫글자를 소문자로 변경한 형식으로 생성이 되는데
							// 클래스 이름이 너무 길거나, 이해하기 어려울 경우 별도로 별명 붙임
public class ToDoList {
	...
	private String td_alaram;//	varchar2(1 byte)
