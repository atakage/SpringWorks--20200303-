...
/*
	...
	마우스를 div box에 올리면 처음 이미지는 감추고, 두 번째 이미지는 보여라
...
.naver_login:hover img:first-child{
	...
	<script>
		$(function(){
			...
			$('btn-login').click(function(){
				...
				$.post("${rootPath}/rest/member/login", $('form').serialize(), 
						function(result){
							alert(result)
				...
				$.ajax({
					...
					url : "${rootPath}/rest/member/login", data: params, dataType: 'json', type: 'POST',
	...
	<form:form method="POST" 
			...
			class="login-form">
		<h2>로그인</h2>
		<c:if test="${param.error != null }">				<!-- param? -->
		...
		<input type="text" id="username" name="username" placeholder="사용자 ID">						<!-- memberVO에 담기는 변수??? -->
