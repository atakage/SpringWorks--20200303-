...
<article>
	...
	<div>${RBOOK.rb_date}, ${RBOOK.rb_stime}부터 ${RBOOK.rb_rtime}시간 읽음</div>
...
<article>
	...
	<button id="btn-delete" type="button" class="flex-right. biz-red">삭제</button>
	<button id="btn-list" type="button" class="flex-right. biz-orange">리스트보기</button>
</article>
