...
<script>
	...
	$(function(){
		...
		['table', ['table']], 
		['insert', ['link', 'hr']], 
		['view', ['fullscreen', 'picture' , 'codeview']]
		...
		$("#bbs_content").summernote({
			...
			lang:"ko-KR", height:'200px', toolbar:toolbar, disableDragAndDrop:false
...
<section>
	...
	<div class="input-group-btn">
		<button class="btn btn-primary" type="button" id="btn-write">게시판작성</button>
	</div>
</div>
